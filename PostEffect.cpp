...
//
//PipelineSet PostEffect::SpriteCreateGraphicsPipeline(ID3D12Device* dev) {
//
//	HRESULT result;
...
//}
//
//void PostEffect::SetPiplineSet(PipelineSet piplineSet)
//{
//	//Sprite::PipelineSet::pipelinestate = piplineSet.pipelinestate;
//}
//
//PostEffect PostEffect::SpriteCreate(ID3D12Device* dev, int window_width, int window_height) {
//
...
//void PostEffect::SpriteCommonBeginDraw(ID3D12GraphicsCommandList* cmdList, const SpriteCommon& spriteCommon) {
//
...
////スプライト単体描画
//
//void PostEffect::SpriteDraw(ID3D12GraphicsCommandList* cmdList, const PostEffect& sprite, const SpriteCommon& spriteCommon, ID3D12Device* dev) {
//
...
//}
//
//SpriteCommon PostEffect::SpriteCommonCreate(ID3D12Device* dev, int window_width, int window_height) {
//	HRESULT result = S_FALSE;
//
//	//新たなスプライト共通データを生成
...
//}
//
//void PostEffect::SpriteUpdate(PostEffect& sprite, const SpriteCommon& spriteCommon) {
//
//	time++;
//
...
//}
//
//void PostEffect::SpriteCommonLoadTexture(SpriteCommon& spriteCommon, UINT texnumber, const wchar_t* filename, ID3D12Device* dev) {
//
...
//}
//
//void PostEffect::SpriteTransferVertexBuffer(const PostEffect& sprite) {
//
//	HRESULT result = S_FALSE;
//
//	//頂点データ
