...
void GameScene::Update()
{
	...
	////ポジション変更と更新
	//titleSprite_.SetPosition(XMFLOAT3(0, 0, 0));
...
void GameScene::Draw()
{
	...
	////sprite_->PostEffectDraw(dxCommon_->GetCommandList(), titleSprite_, spriteCommon_, dxCommon_->GetDevice(),dxCommon_->GetRtvHeap2());
